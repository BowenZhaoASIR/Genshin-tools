<script>
    ...
    import data from './bubble' // or pass data to component as prop
    
    const width = 900; //the margin top, bottom, left, right margin offset relative to the radius
    ...
    const strokeOpacity = 9; // the stroke opacity around the bubbles, if any
