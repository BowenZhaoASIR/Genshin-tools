<script>
  ...
  let characters
  let cards = ''
  const CURRENT_BANNER = ["Yoimya","Yae miko","Kiara","Yunjin","Chonyun"]
	...
	<div class="flexbox">
		<div class="backdiv">
			<form action="/api/drop_user" method="post">
				<button class="back"><a class="textcolor" href="/dashboard/del_user">delete this account</a></button>
			</form>	
		</div>
		<div class="fleximg">
			<div class="img">
