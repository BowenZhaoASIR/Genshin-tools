<script>
  ...
  async function char_name(characters) {
...
<main class="container">
  ...
  <div class="grid img_filter_weapon">
    <button on:click={sword} ><img class="weapon" src="/img/weapon/Sword.webp" alt="Sword"></button>
    <button on:click={claymore} ><img class="weapon2" src="/img/weapon/Claymore.webp" alt="Claymore"></button>
    <button on:click={polearm} ><img class="weapon" src="/img/weapon/Polearm.webp" alt="Polearm"></button>
    <button on:click={catalyst} ><img class="weapon3" src="/img/weapon/Catalyst.webp" alt="Catalyst"></button>
