...
<main class="container">
    <iframe title="teyvat" style="position:fixed; top:-195px; left:380px; bottom:0px; right:0; width:84.5%; height:121%; 
    border:none; margin:0; padding:0; overflow:hidden; z-index:999999;" 
    src="https://genshin-impact-map.appsample.com/location?mid=2" frameBorder="0"></iframe>
